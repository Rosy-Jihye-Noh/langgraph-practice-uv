...
graph_builder.add_edge(START, 'get_tax_base_equation') #병렬
graph_builder.add_edge(START, 'get_tax_deduction') #병렬
graph_builder.add_edge(START, 'get_market_ratio') #병렬 #이거는 웹에서 구함
